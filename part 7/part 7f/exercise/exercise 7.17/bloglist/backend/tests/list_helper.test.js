...
describe('total likes', () => {
  ...
  test('highest likes', () => {
    ...
    const mostLiked = { title: 'Canonical string reduction', author: 'Edsger W. Dijkstra', likes: 12 }
  ...
  test('most blogger', () => {
    ...
    const mostBlogedAuthor = {
      author: 'Robert C. Martin',
      blogs: 3
    }
    // console.log('countBy', _.countBy(listOfBlogs, listOfBlogs.author))
    expect(result).toEqual(mostBlogedAuthor)
